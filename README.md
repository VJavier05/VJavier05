...
#### 🚀 Backend & Frameworks
![Flask](https://img.shields.io/badge/Flask-000000?style=for-the-badge&logo=flask&logoColor=white)&nbsp; ![CodeIgniter](https://img.shields.io/badge/CodeIgniter-EF4223?style=for-the-badge&logo=codeigniter&logoColor=white)&nbsp; 
...
- **Ordering System** (C# / WinForms / MySQL)  
  A system for Ordering Food and Receipt.  
...
- **SheWear E-commerce Website** (HTML / CSS / JavaScript / Python (FLASK) / Dart (FLUTTER) / SQLITE)  
...
- **HRSync HRIS** (HTML / CSS / JavaScript / Python (FLASK) / MYSQL)  
